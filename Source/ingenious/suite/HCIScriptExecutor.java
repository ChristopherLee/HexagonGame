...
/**
 * XML parser for the HCI module
 */
public class HCIScriptExecutor {

    private final XStream xstream;
    private final String TAG_TIMEOUT = "timeout";
    
    private final static HCIScriptExecutor instance = new HCIScriptExecutor();
    
    private HCIScriptExecutor() {
        xstream = new XStream();
        ...
        xstream.alias(TAG_TIMEOUT, TimerException.class);
        ...
        xstream.registerConverter(new TimeoutConverter());
    }
    
    public static HCIScriptExecutor getInstance() {
        return instance;
    }
    ...
    class PlayerGUIConverter implements Converter {
        ...
        public Object unmarshal(HierarchicalStreamReader reader,
        	...
        	String intervalStr = reader.getAttribute("interval");
            ...
            HCIXML obj = new HCIXML(boardXML.getNumberOfPlayers(), 
                                            boardXML.getCurrentPlacements(), 
                                            playerHand, score, interval);
    ...
    class PlacementConverter implements Converter {
        ...
        public void marshal(Object source, HierarchicalStreamWriter writer,
             ...
             writer.addAttribute("c0", placement.getTile().getColor0().toString()); 
             writer.addAttribute("d0", "" + placement.getCoordinate0().getDistance());
             writer.addAttribute("a0", "" + placement.getCoordinate0().getAngle());
             writer.addAttribute("c1", placement.getTile().getColor1().toString());
             writer.addAttribute("d1", "" + placement.getCoordinate1().getDistance());
             writer.addAttribute("a1", "" + placement.getCoordinate1().getAngle()); 
    ...
    class TimeoutConverter implements Converter {

        @Override
        public void marshal(Object source, HierarchicalStreamWriter writer,
                    MarshallingContext context) {
            writer.startNode(TAG_TIMEOUT);
        }
        ...
        @Override
        public boolean canConvert(Class type) {
            return TimerException.class.equals(type);
        }
